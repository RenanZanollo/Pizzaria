...
VALUES
    (1, 'Corte os legumes em cubos, misture com a carne e leve ao forno por 45 minutos.', 'Matheus'),
    (2, 'Misture a farinha, os ovos e o leite, frite em óleo quente até dourar.', 'Isabela'),
    (3, 'Bata todos os ingredientes no liquidificador e asse por 40 minutos em forma untada.', 'Ohata'),
    (4, 'Misture os ingredientes secos, adicione os líquidos e asse por 30 minutos.', 'Lucas'),
    (5, 'Cozinhe o arroz em água fervente por 15 minutos.', 'Gabriel'),
    (6, 'Cozinhe a massa por 10 minutos e adicione o molho de tomate.', 'Amanda'),
    ...
    (12, 'Frite o alho e a cebola, adicione os legumes e cozinhe por 15 minutos.', 'Pedro'),
    ...
    (17, 'Refogue a cebola e o alho, adicione o arroz e a água e cozinhe por 20 minutos.', 'Mariana'),
    ...
    (22, 'Cozinhe o feijão com a carne seca e a linguiça, sirva com arroz e couve refogada.', 'Ana'),
...
VALUES
    ...
    (8, 'Plástico', '30', 20.50),
    (9, 'Plástico', '25', 18.75),
    (10, 'Plástico', '15', 10.25),
    (11, 'Alumínio', '40', 25.99),
    (12, 'Alumínio', '35', 22.50),
    (13, 'Alumínio', '20', 15.99),
    (14, 'Alumínio', '30', 20.50),
...
VALUES
    (1, 'Grande', 'Pizza de Calabresa', 35.99, 'Calabresa', 1, 1, 1),
    (2, 'Média', 'Pizza de Frango com Catupiry', 30.50, 'Frango com Catupiry', 2, 2, 2),
    (3, 'Pequena', 'Pizza de Margherita', 25.75, 'Margherita', 3, 3, 3),
    (4, 'Média', 'Pizza de Quatro Queijos', 27.25, 'Quatro Queijos', 4, 4, 4),
    (5, 'Grande', 'Pizza de Pepperoni', 33.99, 'Pepperoni', 5, 5, 5),
    (6, 'Pequena', 'Pizza de Frango com Catupiry', 25.50, 'Frango com Catupiry', 6, 6, 6),
    (7, 'Grande', 'Pizza de Calabresa', 35.99, 'Calabresa', 7, 7, 7),
    (8, 'Média', 'Pizza de Margherita', 30.50, 'Margherita', 8, 8, 8),
    (9, 'Pequena', 'Pizza de Quatro Queijos', 25.75, 'Quatro Queijos', 9, 9, 9),
    (10, 'Grande', 'Pizza de Pepperoni', 33.99, 'Pepperoni', 10, 10, 10),
    (11, 'Média', 'Pizza de Calabresa', 30.50, 'Calabresa', 11, 11, 11),
    (12, 'Pequena', 'Pizza de Frango com Catupiry', 25.75, 'Frango com Catupiry', 12, 12, 12),
    (13, 'Grande', 'Pizza de Margherita', 35.99, 'Margherita', 13, 13, 13),
    (14, 'Média', 'Pizza de Quatro Queijos', 30.50, 'Quatro Queijos', 14, 14, 14),
    (15, 'Pequena', 'Pizza de Pepperoni', 25.75, 'Pepperoni', 15, 15, 15),
    (16, 'Grande', 'Pizza de Calabresa', 35.99, 'Calabresa', 16, 16, 16),
    (17, 'Média', 'Pizza de Margherita', 30.50, 'Margherita', 17, 17, 17),
    (18, 'Pequena', 'Pizza de Quatro Queijos', 25.75, 'Quatro Queijos', 18, 18, 18),
    (19, 'Grande', 'Pizza de Pepperoni', 33.99, 'Pepperoni', 19, 19, 19),
    (20, 'Média', 'Pizza de Calabresa', 30.50, 'Calabresa', 20, 20, 20),
    (21, 'Pequena', 'Pizza de Frango com Catupiry', 25.75, 'Frango com Catupiry', 21, 21, 21),
    (22, 'Grande', 'Pizza de Margherita', 35.99, 'Margherita', 22, 22, 22),
    (23, 'Média', 'Pizza de Quatro Queijos', 30.50, 'Quatro Queijos', 23, 23, 23),
    (24, 'Pequena', 'Pizza de Pepperoni', 25.75, 'Pepperoni', 24, 24, 24),
    (25, 'Grande', 'Pizza de Calabresa', 35.99, 'Calabresa', 25, 25, 25),
    (26, 'Média', 'Pizza de Margherita', 30.50, 'Margherita', 26, 26, 26),
    (27, 'Pequena', 'Pizza de Quatro Queijos', 25.75, 'Quatro Queijos', 27, 27, 27),
    (28, 'Grande', 'Pizza de Pepperoni', 33.99, 'Pepperoni', 28, 28, 28),
    (29, 'Média', 'Pizza de Calabresa', 30.50, 'Calabresa', 29, 29, 29),
    (30, 'Pequena', 'Pizza de Frango com Catupiry', 25.75, 'Frango com Catupiry', 30, 30, 30);
